 ...
 */
    class SGNodeVisitor {
        ...
        virtual void visitAnimationTransformNode(AnimationTransformNode *node){};
        virtual void visitKeyframeTransformNode(KeyframeTransformNode *node){};
    };
}
