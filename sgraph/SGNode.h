 ...
 */
  ...
  public:
    ...
    /**
     * Add a light to this node. The light position/direction is specified in
     * this node's local coordinate system.
     */
    virtual void addLight(const util::Light& light)=0;

    /**
     * Get the lights attached to this node.
     */
    virtual const vector<util::Light>& getLights() const=0;
